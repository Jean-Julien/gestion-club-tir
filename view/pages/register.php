        ...
        <div class="container">
            <div class="row justify-content-center align-items-center" style="height:100vh">
                <div class="col-md-5 col-sm-12 my-2">
                    <form accept="" class="shadow p-5 bg-dark bg-gradient rounded" method="POST" action="index.php?r=registered">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="exampleInputBirthday1" name="birthdayRegister">
                        </div>
